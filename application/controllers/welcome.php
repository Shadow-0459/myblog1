...
//
//            );
            $rows = $this ->comment_model ->save($username,$email,$phone,$message,$blog_id);//$comment
            if($rows > 0){
                echo 'success';
            }else{
                echo 'fail';
        ...
        public function list_blog(){
            ...
            $this -> load -> view('blog_list',array(
                'blogs' =>  $blogs
            ));//点击a触发href找welcom的list_blog方法下加载view页面函数
        }
        ...
        public function web_demo(){
            $this -> load -> view('web_demo/index.html');
        }
    public function demo_main(){
        $this -> load -> view('web_demo/main.html');
    }
