...
<div id="Navigation">
    <div class="Navigation-list">
        <ul>
            ...
            <li class="Navigation-li"><a href="">MyProjects</a></li>
            <li class="Navigation-li"><a href="">ContactMe</a></li>
        </ul>
    </div>
</div>
<div id="AboutMe">
...
<div id="MyProjects">
    <div class="MyProjects-pane">
        ...
        <ul class="MyProjects-ul">
            <div>
                <li class="<?php echo !$cate_id?'active':''?>"><a href="" >All</a></li>
            ...
            <div class="Skills-content">
                <div class="Skills-content-left">
                    <div class="Skills-content-pane">
                        ...
                        <h3 class="Skillsh4">Web&bvsp;Design<span class="Skillssp">80%</span></h3>
                ...
                <div class="Skills-content-right">
                    <div class="Skills-content-pane">
                        ...
                        <h3 class="Skillsh8">Web&bvsp;Design<span class="Skillssp">80%</span></h3>
